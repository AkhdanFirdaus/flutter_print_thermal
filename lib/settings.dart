        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              /*OutlinedButton(
                  onPressed: conceted ? imprimirTicket : null,
                  child: Text("Imprimir ticket"),
                ),
                OutlinedButton(
                  onPressed: conceted ? imprimirTextoPersonalizado : null,
                  child: Text("Imprimir texto personalizado"),
                ),
                OutlinedButton(
                  onPressed: conceted ? imprimirTesh : null,
                  child: Text("test"),
                ),
                OutlinedButton(
                  onPressed: getStatedBluetooth,
